...
function updateTimer() {
    ...
    if (now > new Date('2024-03-19T15:50:00')) {
        ...
        if (now > new Date('2024-03-19T17:00:00')) {
            ...
            if (now > new Date('2024-03-19T17:00:00')) {
                ...
                if (now > new Date('2024-03-19T10:00:00')) {
                    document.querySelectorAll('#images img')[3].src = 'img/foto4.png';
                    if (now > new Date('2024-03-19T13:30:00')) {
                    ...
                    } else { var targetDate = new Date('2024-03-27T13:30:00'); }
                } else { var targetDate = new Date('2024-03-27T10:00:00'); }
            } else { var targetDate = new Date('2024-03-25T17:00:00'); }
        } else { var targetDate = new Date('2024-03-24T17:00:00'); }
    } else { var targetDate = new Date('2024-03-20T15:50:00'); }
